...
import { AssetsBrowserClient, debugDelay, Item } from './assets-browser.client';
...
export class ItemNode<T extends ItemKind> extends BrowserNode {
    ...
    assetId: string
    borrowed: boolean
    kind: 'data' | 'story' | 'flux-project' | 'package'
    icon: string
    constructor(params:
        {
            id: string, name: string, groupId: string, driveId: string,
